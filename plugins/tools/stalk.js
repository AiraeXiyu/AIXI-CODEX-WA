...
export default {
   ...
   async run(m, {
      ...
      try {
         if (command === 'dcstalk') {
            if (!args[0])
               return m.reply(`🍃 *contoh*: ${isPrefix + command} 100000000000000`)
            m.react('🕒')
            ...
            if (!args[0])
               return m.reply(`🍃 *contoh*: ${isPrefix + command} 10000000`)
            m.react('🕒')
            ...
            if (!args[0])
               return m.reply(`🍃 *contoh*: ${isPrefix + command} AIXI CODEX`)
            m.react('🕒')
            ...
            if (!args[0])
               return m.reply(`🍃 *contoh*: ${isPrefix + command} nama you`)
            m.react('🕒')
